...
function autenticate(){
    ...
    $.ajax({
        ...
        url: `http://129.151.119.223:8081/api/user/${inputEmail}/${inputPassword}`,
...
function gestionaResultado(respuesta){
    ...
    if (respuesta.id==null){
        $("#alerta").show();
        $("#mensaje").html("No se ha encontrado ningún usuario con los datos ingresados, por favor intenta de nuevo");
        $("#inputEmail").focus();
    }else{
